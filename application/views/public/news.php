            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    <div class="news-content">
                        <a href="#"><img src="images<?php echo base_url('assets/images/1.jpg')?>" alt=""></a>
                        ...
                        <header class="entry-header d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <div class="donate-icon">
                                <a href="#"><img src="<?php echo base_url('assets/images/donate-icon.png')?>" alt=""></a>
                            </div>
                        </header>
                    ...
                    <div class="news-content">
                        <a href="#"><img src="<?php echo base_url('assets/images/2.jpg')?>" alt=""></a>
                    ...
                    <div class="news-content">
                        <a href="#"><img src="<?php echo base_url('assets/images/3.jpg')?>" alt=""></a>
                ...
                <div class="col-12 col-lg-4">
                    <div class="sidebar">
                        ...
                        <div class="upcoming-events">
                            ...
                            <ul class="p-0">
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo base_url('assets/images/u-1.jpg')?>" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo base_url('assets/images/u-2.jpg')?>" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo base_url('assets/images/u-3.jpg')?>" alt=""></a></figure>
                        ...
                        <div class="featured-cause">
                            ...
                            <div class="cause-wrap">
                                <figure class="m-0 position-relative">
                                    <a href="#"><img src="<?php echo base_url('assets/images/cause-3.jpg')?>" alt=""></a>
                                </figure>

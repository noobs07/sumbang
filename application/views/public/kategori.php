        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="cause-wrap d-flex flex-wrap justify-content-between">
                        ...
                        <div class="cause-content-wrap">
                            <header class="entry-header d-flex flex-wrap align-items-center">
                                <h3 class="entry-title w-100 m-0"><a href="<?php echo base_url('home/detail')?>">Fundraiser for Kids</a></h3>
                ...
                <div class="col-12 col-lg-6">
                    <div class="cause-wrap d-flex flex-wrap justify-content-between">
                        <figure class="m-0">
                            <img src="<?php echo base_url('assets/images/eye-for.jpg')?>" alt="">
                        </figure>
                        ...
                        <div class="cause-content-wrap">
                            <header class="entry-header d-flex flex-wrap align-items-center">
                                ...
                                <div class="posted-date">
                                    <a href="<?php echo base_url('home/detail')?>">Aug 25, 2018 </a>
                                </div><!-- .posted-date -->

                                <div class="cats-links">
                                    <a href="<?php echo base_url('home/detail')?>">Ball Room New York</a>
                                </div><!-- .cats-links -->
                            </header><!-- .entry-header -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        ...
                        <div class="cause-content-wrap">
                            <header class="entry-header d-flex flex-wrap align-items-center">
                                <h3 class="entry-title w-100 m-0"><a href="<?php echo base_url('home/detail')?>">Education for all</a></h3>
                            </header><!-- .entry-header -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 order-2 order-lg-1">
                    ...
                    <div class="entry-footer mt-5">
                        <a href="<?php echo base_url('home/detail')?>" class="btn gradient-bg">Donate Now</a>
                    </div><!-- .entry-footer -->
                </div><!-- .col -->

                <div class="col-12 col-lg-5 order-1 order-lg-2">
                    <img src="<?php echo base_url('assets/images/oshomah.jpg')?>" alt="">
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        <figure class="m-0">
                            <img src="<?php echo base_url('assets/images/cause-4.jpg')?>" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        <figure class="m-0">
                            <img src="<?php echo base_url('assets/images/cause-5.jpg')?>" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        <figure class="m-0">
                            <img src="<?php echo base_url('assets/images/cause-6.jpg')?>" alt="">
